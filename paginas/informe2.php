    ...
    <table class="table">
        ...
        <tbody>
            <?php foreach ($resultado as $servicio): ?>
                <tr>
                    <td><?php echo $servicio['numrun1']; ?></td>
                    <td><?php echo $servicio['giro']; ?></td>
                    <td><?php echo $servicio['monto_fiado']; ?></td>
                    <td><?php echo $servicio['limite_fiado']; ?></td>
                    <td><?php echo $servicio['razon_social']; ?></td>
                    <td><?php echo $servicio['direccion_nombre_calle']; ?></td>
                    <td><?php echo $servicio['direccion_numero']; ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
